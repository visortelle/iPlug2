...
, OSCSender("127.0.0.1", 8001)
{
  ...
  mLayoutFunc = [&](IGraphics* pGraphics) {
    ...
    pGraphics->AttachControl(new IVNumberBoxControl(topRow.SubRectHorizontal(3, 1).GetPadded(-10.f), kNoParameter, setSendIPAndPort, "Send Port", DEFAULT_STYLE, true, 8001, 4000, 10000), kCtrlTagSendPort);
    ...
    }, "Receive Port", DEFAULT_STYLE, true, 8000, 4000, 10000));
